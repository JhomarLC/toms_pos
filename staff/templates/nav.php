...
<div class="aside-menu flex-column-fluid pt-0 pb-7 py-lg-10" id="kt_aside_menu">
    ...
    <div id="kt_aside_menu_wrapper" class="w-100 hover-scroll-y scroll-ms d-flex" data-kt-scroll="true"
        ...
        <div id="kt_aside_menu"
            ...
            <!--begin:Menu item-->
            <!--begin:Menu item-->
            <div class="menu-item mb-5" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-dismiss="click"
                title="POS">
                <!--begin:Menu link-->
                <a class="menu-link active" href="staff/">
            ...
            <div class="menu-item mb-5" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-dismiss="click"
                title="Orders">
                <!--begin:Menu link-->
                <a class="menu-link" href="staff/orders/">
                    <span class="menu-icon me-0">
            ...
            <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start"
                ...
                <div class="menu-sub menu-sub-dropdown px-2 py-4 w-250px mh-75 overflow-auto">
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link" href="staff/inventory/stocks">
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link" href="staff/inventory/expenses">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
