<div class="modal fade" tabindex="-1" id="add_category_modal">
    <div class="modal-dialog modal-dialog-centered">
        <div class=" modal-content">
            ...
            <div class="modal-body">
                <form action="#" id="add_category_form" class="form" autocomplete="off" enctype="multipart/form-data">
                    <!--begin::Input group-->
                    <div class=" mb-7">
                        ...
                        <div class="image-input image-input-outline image-input-placeholder" data-kt-image-input="true">
                            ...
                            <div class="image-input-wrapper w-125px h-125px"
                                style="background-image: url(images/uploads/do-not-delete/logo.png);">
                            </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" id="clear_category_form">Close</button>
                        <!--begin::Actions-->
                        <button id="add_category_submit" type="submit" class="btn btn-primary">
