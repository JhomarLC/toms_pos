<div class="modal fade" tabindex="-1" id="add_item_modal">
    <div class="modal-dialog modal-dialog-centered">
        <div class=" modal-content">
            <div class="modal-header">
                ...
                <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" id="close_item_modal">
                    <i class="ki-duotone ki-cross fs-1"><span class="path1"></span><span class="path2"></span></i>
                </div>
                <!--end::Close-->
            </div>
            <div class="modal-body">
                <form action="#" id="add_item_form" class="form" autocomplete="off" enctype="multipart/form-data">
                    <!--begin::Input group-->
                    <div class=" mb-7">
                        ...
                        <div class="image-input image-input-outline image-input-placeholder" data-kt-image-input="true">
                            ...
                            <div class="image-input-wrapper w-125px h-125px"
                                style="background-image: url(images/uploads/do-not-delete/logo.png);"></div>
                        ...
                        <div class="input-group input-group-solid flex-nowrap">
                            ...
                            <div class="overflow-hidden flex-grow-1">
                                <select class="form-select form-select-solid rounded-start-0 border-start"
                                    data-control="select2" name="category_id" data-dropdown-parent="#add_item_modal"
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <textarea class="form-control form-control-solid mb-3 mb-lg-0" name="description"
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" id="clear_item_form">Close</button>
                        <!--begin::Actions-->
                        <button id="add_item_submit" type="submit" class="btn btn-primary">
