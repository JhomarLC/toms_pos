                            ...
                            <div class="card-body py-4">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_items">
                                    ...
                                    <tbody class="text-gray-600 fw-semibold">
                                        <?php
								$query = "SELECT  c.*, i.* FROM category as c
                                INNER JOIN items as i ON c.category_id = i.category_id ORDER BY i.item_id DESC";
                                ...
                                if($result->num_rows > 0){
                                    while($item = $result->fetch_assoc()){?>
                                        <tr>
                                            <td>
                                                <div class="badge badge-light fw-bold"><?= $item['category_name'] ?>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <div class="symbol symbol-50px overflow-hidden me-3">
                                                    <div class="symbol-label">
                                                        <img src="images/uploads/<?= $item['image'] ?>" alt="Emma Smith"
                                                            class="w-100" />
                                                    </div>
                                                </div>
                                                <!--end:: Item Image -->
                                            ...
                                            <td>
                                                ...
                                                <div class="badge badge-light-success fw-bold"><?= $item['status'] ?>
                                                </div>
                                                <?php } elseif ($item['status'] == 'archived') {?>
                                                <div class="badge badge-light-danger fw-bold"><?= $item['status'] ?>
                                                </div>
                                                <?php } ?>
                                            </td>
                                            <td class="d-flex gap-3 flex-end">
                                                <!--begin::Edit user-->
                                                <button type="button" class="btn btn-sm btn-success"
                                                    onclick="GetEditValueItem(<?= $item['item_id'] ?>)">
                                                ...
                                                <button type="button" class="btn btn-sm btn-danger"
                                                    onclick="ArchiveItem(<?= $item['item_id'] ?>, '<?= $item['status'] ?>')">
