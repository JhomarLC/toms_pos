        ...
        <div id="kt_aside_menu"
            ...
            <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start"
                ...
                <div class="menu-sub menu-sub-dropdown px-2 py-4 w-250px mh-75 overflow-auto">
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link" href="admin/menu/category">
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link" href="admin/menu/item">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link" href="admin/menu/discount">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
            ...
            <div class="menu-item" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-dismiss="click"
                ...
                <!--begin:Menu link-->
                <a class="menu-link" href="admin/accounts">
            ...
            <!--begin:Menu item-->
            <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start"
                class="menu-item here shows py-2">
                <!--begin:Menu link-->
                <span class="menu-link menu-center">
                    <span class="menu-icon me-0">
                ...
                <div class="menu-sub menu-sub-dropdown px-2 py-4 w-250px mh-75 overflow-auto">
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link" href="admin/inventory/stocks">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link active" href="admin/inventory/expenses">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
            ...
            <div class="menu-item" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-dismiss="click"
                title="History">
                <!--begin:Menu link-->
                <a class="menu-link" href="admin/history">
                    <span class="menu-icon">
                        <i class="ki-duotone ki-brifecase-timer fs-2x">
                            <span class="path1"></span>
                            <span class="path2"></span>
                            <span class="path3"></span>
                        </i>
